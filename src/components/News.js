...
export default class News extends Component {
    ...
    handleNextClick = async () => {
        ...
        // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=d6606a79556a4701b3d4fbcc5aa7bde4&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
        ...
        console.log((this.state.page) * this.props.pageSize, this.props.pageSize * (this.state.page + 1));
    ...
    handlePreviousClick = async () => {
        ...
        //     loading: false
        // })
        console.log((this.state.page - 1) * this.props.pageSize, this.state.page * this.props.pageSize);
    ...
    async componentDidMount() {
        // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=d6606a79556a4701b3d4fbcc5aa7bde4&page=1&pageSize=${this.props.pageSize}`
        // this.setState({ loading: true })
        ...
        // }
        console.log(SampleOutput.articles.length);
    ...
    render() {
        ...
        return (
            <div className='container my-15'>
                <h2 style={{ textAlign: "center", margin: "30px 0px" }}>NewsMonkey - Top Headlines from {this.capitalize(this.props.category)}</h2>
                ...
                <div className="container d-flex justify-content-between my-2">
                    ...
                    <button disabled={(this.state.page + 1) > Math.ceil(SampleOutput.articles.length / this.props.pageSize)} className="btn btn-dark" onClick={this.handleNextClick}>Next &rarr;</button>
